...
const SignIn: React.FC = () => {
  ...
  const handleActionProviderButton = async (
  ...
  try {
    ...
    console.error(
      "Error autenticando con provider:",
      error
    );
  }
};
              ...
              >
                {({ handleSubmit }) => (
                  <Form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 p-6 bg-white rounded-md shadow-md">
                    ...
                    {/* botones de google, microsoft, github */}
                    <div className="flex flex-col gap-4">
                      <ProviderButton
                      icon={<FcGoogle size={20} />}
                      label="Sign in with Google"
                      action={() => handleActionProviderButton("google")}
                    />
                    <ProviderButton
                      icon={<FaMicrosoft size={20} />}
                      label="Sign in with Microsoft"
                      action={() => handleActionProviderButton("microsoft")}
                    />
                    <ProviderButton
                      icon={<FaGithub size={20} />}
                      label="Sign in with Github"
                      action={() => handleActionProviderButton("github")}
                    />
                    </div>
                  </Form>
                )}
